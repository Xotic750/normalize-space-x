...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["normalizeSpaceX"] = factory();
	else
		root["normalizeSpaceX"] = factory();
})((function () {
  'use strict';
...
exports.normalizeSpace2016 = normalizeSpace2016;
exports.default = normalizeSpace2018;

var _trimX = _interopRequireWildcard(__webpack_require__(2));
...
var reNormalize2016 = new RegExpCtr("[".concat(_whiteSpaceX.string2016, "]+"), 'g');
var reNormalize2018 = new RegExpCtr("[".concat(_whiteSpaceX.default, "]+"), 'g');
var _ref = '',
...
function normalizeSpace2016(string) {
  return replace.call((0, _trimX.trim2016)(string), reNormalize2016, ' ');
}
/**
 * This method strips leading and trailing white-space from a string,
 * replaces sequences of whitespace characters by a single space,
...
function normalizeSpace2018(string) {
  return replace.call((0, _trimX.default)(string), reNormalize2018, ' ');
}
...
//# sourceMappingURL=normalize-space-x.js.map